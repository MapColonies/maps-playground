...
let rasterLayer;
  ...
  const vectorSource = new ol.source.Vector({
    ...
    url: function(extent) {
      return VECTOR_WFS_URL + `?service=WFS&version=2.0.0&request=GetFeature&typeName=core:buildings_polygon&srsname=EPSG:4326&bbox=${extent.join(',')},EPSG:4326&token=${TOKEN}&outputFormat=application/json&maxFeatures=10000`;
    }
  });
